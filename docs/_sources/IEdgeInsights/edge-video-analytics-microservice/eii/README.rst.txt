...
Download the required model files to be used for the pipeline mentioned in `config <https://github.com/open-edge-insights/eii-core/blob/master/home/rkamal/eii/github/applications.industrial.edge-insights.open-edge-insights-github-io/eii_repo/IEdgeInsights/edge-video-analytics-microservice/eii/config.json>`_
by following the steps two-four mentioned in `README <https://github.com/open-edge-insights/eii-core/blob/master/home/rkamal/eii/github/applications.industrial.edge-insights.open-edge-insights-github-io/eii_repo/IEdgeInsights/edge-video-analytics-microservice/README.md#running-the-image>`_.
