...
* 
  ...
  #. 
     To start the mqtt-publisher with temperature and humidity data, please refer `tools/mqtt-publisher/README.md <https://github.com/open-edge-insights/eii-tools/blob/master/mqtt/README.md>`_
